...
if TYPE_CHECKING:  # pragma: no cover - annotation only
    # Used for one annotation on one method. ``from __future__ import annotations`` keeps
    # annotations as strings, so the symbol is never needed at runtime. This module still
...
from quant_ai.backtesting.datasets import (
