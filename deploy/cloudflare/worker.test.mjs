...
test("research lab and operator notes are excluded before cloud snapshot storage",async()=>{
 ...
 snapshots["/api/workspace"]={tenantId:"india-paper",researchLab:{private:"RESEARCH_SENTINEL"},researchPortfolio:{private:"PORTFOLIO_SENTINEL"},paperContribution:{private:"CONTRIBUTION_SENTINEL"},historicalRisk:{private:"RISK_SENTINEL"},companyEvents:{private:"EVENT_SENTINEL"},audit:["NOTES_SENTINEL"],runtime:{status:"running"}};
