 ...
 async fetch(request,env) {
  ...
  if(url.pathname==="/_ingest"){
   ...
   if(payload.snapshots["/api/workspace"]?.tenantId==="india-paper") {
    const {researchLab,researchPortfolio,paperContribution,historicalRisk,benchmarkPerformance,companyEvents,audit,...workspace}=payload.snapshots["/api/workspace"];
