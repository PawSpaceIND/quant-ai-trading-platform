...
| P31 | Benchmark return attribution workspace | Reconciled allocation/selection/interaction, exact input hash, period and portfolio labels, private display/export/Atlas and recovery inventory | Engineering/container/browser verified on synthetic evidence at main `9c3d358` (CI [34929721116](https://github.com/PawSpaceIND/quant-ai-trading-platform/actions/runs/34929721116)); real source, total-return/corporate-action, sector/factor and target-host qualification open; [scope](BENCHMARK_ATTRIBUTION.md) |
| P32 | Selected external broker funds/net-position observation | Profile before/after, repeated funds and position reads, account-bound hash, private Activity/export/Atlas, source scope and freshness | Engineering/container/browser verified on synthetic evidence at main `9c3d358` (CI [34929721116](https://github.com/PawSpaceIND/quant-ai-trading-platform/actions/runs/34929721116)); real account, depository holdings, settlement and continuous cash/position reconciliation open; [scope](EXTERNAL_ACCOUNT_SNAPSHOT.md) |
