...
| P16 | Provider and market-event research | Provider receipts, continuous portfolio journal, time-aware company-event evidence, real source/provider qualification | Framework/tests integrated from #52; two-provider/live-source and additional UI integration pending |
