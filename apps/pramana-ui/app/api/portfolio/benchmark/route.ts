...
export async function GET(request:Request) {
  ...
  } catch {return NextResponse.json({error:"Account benchmark evidence is unavailable."},{status:503,headers:{"Cache-Control":"no-store","Content-Disposition":'attachment; filename="pramana-account-benchmark-unavailable.json"'}});}
}
