...
type Row = { symbol: string; available: boolean; price?: number; change?: number | null; volume?: number; lastTrade?: string; exchangeTimestamp?: string; history?: {date: string; close: number}[]; instrument?: {market: string; assetClass: string; currency: string; exchange: string; contract?: string; expiry?: string; underlying?: string; optionType?: string; strike?: number; product?: string; segment?: string; lotSize?: number; tickSize?: number} };
